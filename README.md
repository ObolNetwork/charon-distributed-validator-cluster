...
1. Create the artifacts needed to run a testnet distributed validator cluster
   ...
   docker run --rm -v "$(pwd):/opt/charon" ghcr.io/obolnetwork/charon:v0.15.0 create cluster --withdrawal-address="0x000000000000000000000000000000000000dead" --nodes 6 --threshold 5
   ```
...
docker run --rm -v $(pwd):/opt/charon obolnetwork/charon:v0.15.0 create cluster --split-existing-keys --split-keys-dir=/opt/charon/split_keys --threshold 4 --nodes 6
